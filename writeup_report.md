...
The model is the Nvidia end to end driving model.

The only differences are input image shape, and the addition of dropout layers to increase generalization in the model.
